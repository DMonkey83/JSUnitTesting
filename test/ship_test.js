...
describe('checkForShip', function(){
    ...
    it('should handle ships located in more than one coordinate', function(){
    ...
    it('should handle multiple ships located in more than one coordinate', function(){
      player = {
        ships: [
	    {
		locations: [[0, 0], [1, 1]]
	...
	expect(checkForShip(player, [0,2])).to.deep.equal(player.ships[1]);
